				  ...
				  <!-- /sidebar -->
				        <div id="sidebar"> 
						     <h4 class="menu">Menu</h4>
						          <ul>
							    <li><a href="upcoming.html">Advertisement Inbox <i class="glyphicon glyphicon-triangle-bottom"> </i> </a>
							      <ul>
				...
				<div class="container">
					<div class="wthree_service_breadcrumb_left">
						<ul>
							...
							<li>Advertisement Inbox</li>
						</ul>
					</div>
					<div class="wthree_service_breadcrumb_right">
						<h3>Advertisement Inbox</h3>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
		    ...
		    <div class="tips w3l">
				<div class="container">
				 <div class="col-md-9 tips-info">
								...
								include("db.php");
									$id=$_SESSION["idd"];
									$rr=mysqli_query($con,"select * from user_advertisement where  user_id='$id'");
					 ...
					 <div class="news-grid">
					    <div class="news-img up">
						  <a href="single.html"> <img src="advertisement_photo/<?php echo $rr1;  ?>" alt=" " class="img-responsive"></a>
						  <span class="price1">NEW</span>
						</div>
					    <div class="news-text coming">
						    <h3><a href="single.html"><?php echo $row[3]; ?></a></h3>
							<h5>Launched On: 07-Jun-2016</h5>
							<p class="news">Price: Rs <?php echo $row[6]; ?> Lacs Ex-showroom, New Delhi</p>
							<h6>Not rated yet,<a href="single.html"> Be the first one to write a review</a></h6>
							<a href="delete.php?a=<?php  echo $row[0] ?>" class="read hvr-shutter-in-horizontal">Delete Advertisement</a>
