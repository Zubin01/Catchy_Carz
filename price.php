			       ...
			       <div class="col-md-5 price-img">
				     <div class="view second-effect">
												<a href="single.html" title="Catchy Carz">
													<img src="admin/new_cars/<?php  echo $photo[0]; ?>" alt="" class="img-responsive">
													<div class="mask">
				   ...
				   <div class="col-md-4 price-text">
				       <div class="price-text-sec">
						   ...
						   <div class="inner-price">
						         <h5 style='color:black'>Ex-Showroom Price</h5>
								 <p>8,55,850</p>
								<div class="clearfix"> </div>
						   </div>
						   <div class="inner-price">
						         <h5 style='color:black'>RTO</h5>
								 <p>61,776</p>
								<div class="clearfix"> </div>
						   </div>
						   <div class="inner-price">
						         <h5  style='color:black'>Insurance</h5>
								 <p>61,776</p>
								<div class="clearfix"> </div>
						   </div>
						   <div class="inner-price lost">
						         <h5  style='color:black'>On-Road Price (New Delhi)</h5>
								 <p> 9,79,403</p>
								<div class="clearfix"> </div>
						   </div>
						</div>
