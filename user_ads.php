...
<!-- discounts-->
		...
		<div class="used-car w3l">
			...
			<?php
					...
					{
					echo "<h4 class='tittle' style='text-align:right;color:blue'>Welcome $row[1]</h4>";
					}
				?>	
				<div class="cities-section w3-agile" style="margin:auto">
				
				    <h3 class="tittle">BEST USED CARS</h3>
				  
				  
				  <ul class="cities-grids" style='max-width:1120px;margin:auto'>
				  
						<?php
							include('admin/db.php');
							
							
								$rr=mysqli_query($con,"select * from user_advertisement");
				  ...
				  <li>
					  <div class="view two second-effect">
						<a href="single.php?a=<?php  echo $ro[0]; ?>" title="Catchy Carz">
							<img src="advertisement_photo/<?php echo $ro[5] ?>" alt="" 
			  ...
			  <h3 class="tittle">USED CARS BY PRICE</h3>
				<div class="col-md-4 pricing-plans">
					<div class="pricing-plan1">
						...
						$r=mysqli_query($con,"select * from user_advertisement where price between 1 and 6");
						while($row=mysqli_fetch_array($r)){
						
						?>
							<li><a href="single.php?a=<?php echo $row[0] ?>"><?php echo $row[3] ?></a></li>
							<li><?php echo $row[6] ?> L searches</li>
						<?php
						}
						?>
						</ul>
				...
				<div class="col-md-4 pricing-plans">
					<div class="pricing-plan1">
						...
						$r=mysqli_query($con,"select * from user_advertisement where price between 6 and 12 limit 3");
						while($row=mysqli_fetch_array($r)){
				...
				<div class="col-md-4 pricing-plans">
					<div class="pricing-plan1">
						...
						$r=mysqli_query($con,"select * from user_advertisement where price > 12 limit 3");
						while($row=mysqli_fetch_array($r)){
