  ...
  var availableTags = [
    ...
    $( "#tags" ).autocomplete({
      source: availableTags
			...
			<table class='table-condensed' height='100px' width='235px' align='center'>
			<tr>
			<td>
			<b style='color:black'>Search</b>
			</td>
			<td>
			<input type='text' name='se' id='tags' 
			placeholder='Enter search term here.....' class='form-control'>
			</td>
			</tr>
			</table>
			</div>
				 ...
				 <div class="col-md-9 tips-info">
					 ...
					 <div class="news-grid">
						...
						if(isset($_SESSION["idd"]))
						{
								...
								$id=$_SESSION["idd"];
								$r=mysqli_query($con,"select * from favorites where car_id='$row[0]'
								 and user_id='$id'");
							...
							{
							?>
							<a href="favorite.php?a=<?php echo $row[0]; ?>" class="read hvr-shutter-in-horizontal">Add As Favorite</a>
