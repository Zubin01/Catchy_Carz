		...
		<!--/breadcrumb-->
		    <div class="service-breadcrumb w3-agile">
				<div class="container">
					<div class="wthree_service_breadcrumb_left">
						<ul>
							...
							<li><a href="new_cars.php">New Cars</a> <i>|</i></li>
				...
				if($row=mysqli_fetch_array($r)){
					...
					echo "		<li><a href='index.php'>$row[1]</a> <i>|</i>
					 </li>
					";
					}
					?>
				...
				if($row=mysqli_fetch_array($r)){
					...
					echo "<h4 style='color:black'> $row[1]</h4>
					";
					$name_car=$row[1];
					}
					?>
				...
				<script>
					...
					$(document).ready(function()
					{
						$("img").click(function()
						{
							...
							main_img.src="admin/new_cars/"+values;
						});
					});
				</script>
			<?php
				...
				$cars_photo=$row[10];
				$pname=explode(",",$cars_photo);
				?>
				<div class="sample1" >
						<?php
						echo "<h3 style='text-align:center;color:black'>".$name_car."</h3>";
						?>
					<div class="carousel" style="height: 341px;">
							 <h2 style='text-align:center; text-transform:capitalize'><?php echo $row[3] ?></h2>
							<img name='main_img' src="admin/new_cars/<?php echo $pname[0]; ?>" 
							alt="maiores alias consequ" class='img-responsive'
					...
					<br><br/><br/>
						...
						<img id='<?php echo $pname[$i]; ?>' 
						src='admin/new_cars/<?php echo "$pname[$i]" ?>' height=140 width=120 
...
<script>
	...
	$(document).ready(function()
	{
		$("#btn").click(function()
		{
			...
			$.post("get1.php",{review:reviews,id:ids},function(data)
			{
					$("#reviews_show").html(data).show();
			});
...
<br/>
							...
							<?php
								$id=$_SESSION["idd"];
								$car_id=$_REQUEST["a"];
								$r=mysqli_query($con,"select * from favorites where car_id='$car_id'
								 and user_id='$id'");
							
							if($row11=mysqli_fetch_array($r)){
							
							
							?>
							<a href="view_favorite.php" class="read hvr-shutter-in-horizontal">Already Added As Fav.</a>
							...
							{
							?>
							<a href="favorite.php?a=<?php echo $car_id; ?>" class="read hvr-shutter-in-horizontal">Add As Favorite</a>
				...
				<div class="single-left3">
							...
							<tr>
							<td>
							Vehicle Name:</td><td><?php  echo $row[1] ?>
							</td>
							</tr>
							<tr>
							<td>
							Category:</td><td><?php echo $row[2] ?>
							</td>
							</tr>
							<tr>
							<td>
							Brand: </td><td><?php echo $row[3] ?>
							</td>
							</tr>
							<tr>
							<td>
							Color: </td><td><?php echo $row[13] ?>
							</td>
							</tr>
							<tr>
							<td>
							Price: </td><td><?php echo $row[4] ?> &nbsp; Lacs
							</td>
							</tr>
							<tr>
							<td>
							Fuel type: </td><td><?php echo $row[5] ?>
							</td>
							</tr>
							<tr>
							<td>
							Transmission:</td><td><?php echo $row[12] ?>
							</td>
							</tr>
							<tr>
							<td>
							Engine Displacement: </td><td><?php echo $row[6] ?>
							</td>
							</tr>
							<tr>
							<td>
							Mileage: </td><td><?php echo $row[7] ?>
							</td>
							</tr>
							<tr>
							<td>
							Air Conditioning: </td><td><?php echo $row[8] ?>
							</td>
							</tr>
							<tr>
							<td>
							Air Bags: </td><td><?php echo $row[9] ?>
							</td>
							</tr>
							<tr>
							<td>
							Photos: </td><td><?php echo $row[10] ?>
							</td>
							</tr>
							<tr>
							<td>
							Description.:</td><td><?php echo $row[11] ?>
							</td>
							</tr>
							
						<tr><td colspan='2'><input type='hidden' value='<?php  echo $id; ?>' id='id'></td></tr>
					...
					<div class='view1'>
<br/>
<center><b style='color:black'>Enter Review here :</b>
<br/>
<textarea id='review' style='color:black;width:400px;height:50px;'></textarea>
</center><br/>

<center>
<input type='button' value='REVIEW'  id='btn'>
</center>
</div>
...
?>
			...
			<div class="blo-top">
						<div class="tech-btm">
		<a href="view_favorites.php" class="btn btn-warning btn-block btn-lg" role="button">VIEW FAVORITES</a> 
			...
			<marquee direction='up' height=400 scrollamount=4>
				...
				<div class="related-posts">
										<table class="table table-hover"><tr><td><h3>`</h3></td>
										</tr>
										</table>
										<hr/>
