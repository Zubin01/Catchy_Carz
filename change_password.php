...
<!-- discounts-->
			...
			<br/>
			<br/>
			<form action='change_password2' method='post'>
			<div style='box-shadow: 10px 10px 10px #888678'>
			<table class='table-condensed table-hover'  align='center' height='200px' width='500px' cellspacing='0' cellpadding='1'>
			<tr>
			<td colspan='2' align='center'>
			<h4 style="color:black">Get new password from here</h5> 
			</td>
			</tr>
			<tr>
			<td>
			...
			<td>
			<input type='password' name='ps1' value='' placeholder='********' class='form-control'>
			</td>
			</tr>
			<tr>
			<td colspan='2' align='center'>
			<input type='submit' name='btn00' value='Submit' class='btn-info'>
			</td>
			</tr>
			</table>
			</form>
